inherited frmPlanoConta: TfrmPlanoConta
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbeNomePlano: TPLDBEdit [0]
    Left = 64
    Top = 32
    Width = 337
    Height = 21
    ...
    EditLabel.FocusControl = dbeNomePlano
    Button.Left = 402
    Button.Top = 31
    Button.Width = 0
    Button.Height = 0
  ...
  object sqldPadrao: TPLSQLDataSet
    CommandText = 
      'select PC.CODPLANOCONTAS, '#13#10'       PC.DESCRICAO'#13#10'from PLANOCONTA' +
      'S PC'#13#10'where PC.CODPLANOCONTAS = :CODPLANOCONTAS'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
